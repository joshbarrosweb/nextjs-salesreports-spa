...
export const ClientList: React.FC = () => {
  ...
  const handlePage = (event: DataTablePageParams) => {
    setLoading(true);
    service.searchClientService(filter.name, filter.cpf, event?.page, event?.rows)
      .then(result => {
    ...
    <Layout title="Clients">
      <form onSubmit={formikSubmit}>
        ...
        <div className="field is-grouped">
          ...
          <div className="control is-link">
            <button type="submit" onClick={e => Router.push("/submissions/clients")} className="button is-warning">
              New
            </button>
          </div>
        </div>
